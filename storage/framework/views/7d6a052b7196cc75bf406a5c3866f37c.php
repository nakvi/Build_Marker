                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr  <?php if($loop->even): ?> class="bg-light bg-opacity-50" <?php endif; ?>>
                                    ...
                                    <td class=""><?php echo e($foreman->name); ?></td>
                                    <td class=""><?php echo e($foreman->email); ?></td>
                                    <td class=""><?php echo e($foreman->address); ?></td>
                                    <td class=""><?php echo e($foreman->phone); ?></td>
                                    <td class="text-center ">
                                        <ul class="gap-2 mb-0 p-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                <a class="edit-item-btn" data-id="<?php echo e($foreman->id); ?>"  href="#showModal" data-bs-toggle="modal"><i
                                                            class="ri-pencil-fill align-bottom text-muted"></i></a>
                                            </li>
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                <a class="remove-item-btn" data-id="<?php echo e($foreman->id); ?>"  data-bs-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary p-3">
                    <h5 class="modal-title text-white" id="exampleModalLabel">Add foreman</h5>
                    <button type="button" class="btn-close bg-white" data-bs-dismiss="modal" aria-label="Close"
                        id="close-modal"></button>
                </div>
                <form class="tablelist-form preloaderForm"  id="leadtype_form" action="<?php echo e(url('/add_foreman')); ?>"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5 text-center">
                    ...
                    <div class="mt-4 text-center">
                        <h4 class="fs-semibold">You are about to delete a foreman ?</h4>
                        <p class="text-muted fs-14 mb-4 pt-1">Deleting your foreman will
...
<?php $__env->startSection('script'); ?>
    ...
    jQuery(document).ready(function($) {
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            var url = '<?php echo e(url("/foreman_edit")); ?>' + '/' + itemId + '/edit';
            $.ajax({
                    url: url, // Adjust the route as needed
                    type: 'GET',
                    success: function(response) {
                        var foreman = response.foreman;

                        $('#id-field').val(foreman.id);
                        $('#name').val(foreman.name);
                        $('#email').val(foreman.email);
                        $('#address').val(foreman.address);
                        $('#phone').val(foreman.phone);

                        $('#exampleModalLabel').html("Edit Foreman");
                        ...
                        $('#leadtype_form').attr('action', '<?php echo e(url("/foreman_update")); ?>/' + itemId);
    ...
    var itemId = $(this).data('id');
    var url = '/foreman_delete/' + itemId; // Use the correct delete route
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\build_marker\resources\views/frontend/foreman/foreman.blade.php ENDPATH**/ ?>