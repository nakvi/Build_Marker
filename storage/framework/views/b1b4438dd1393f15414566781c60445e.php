                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                ...
                                <h2 class="text-primary">BUILDMARKER</h2>
                    ...
                    <div class="card card-bg-fill">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to Bulid Marker</p>
                            </div>
                            <div class="p-2 mt-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> BUILDMARKER. Crafted with <i class="mdi mdi-heart text-danger"></i> by BUILDMARKER</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\build_marker\resources\views/auth/login.blade.php ENDPATH**/ ?>