                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                {{-- <img src="{{ URL::asset('build/images/Engagement_MM.png')}}" alt="" height="20"> --}}
                                <h2 class="text-primary">BUILDMARKER</h2>

                            </a>
                        </div>
                        {{-- <p class="mt-3 fs-15 fw-medium text-muted">Unlock Your Potential with Engagement Multi Marketing</p> --}}
                    </div>
                </div>
            </div>
            <!-- end row -->
