                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr  @if ($loop->even) class="bg-light bg-opacity-50" @endif>
                                    ...
                                    <td class="">{{ $foreman->name }}</td>
                                    <td class="">{{ $foreman->email }}</td>
                                    <td class="">{{ $foreman->address }}</td>
                                    <td class="">{{ $foreman->phone }}</td>
                                    <td class="text-center ">
                                        <ul class="gap-2 mb-0 p-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                <a class="edit-item-btn" data-id="{{ $foreman->id }}"  href="#showModal" data-bs-toggle="modal"><i
                                                            class="ri-pencil-fill align-bottom text-muted"></i></a>
                                            </li>
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                <a class="remove-item-btn" data-id="{{ $foreman->id }}"  data-bs-toggle="modal"
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form class="tablelist-form preloaderForm"  id="leadtype_form" action="{{ url('/add_foreman') }}"
...
@section('script')
    ...
    jQuery(document).ready(function($) {
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            var url = '{{ url("/foreman_edit") }}' + '/' + itemId + '/edit';
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#leadtype_form').attr('action', '{{ url("/foreman_update") }}/' + itemId);
