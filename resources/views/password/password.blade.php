...
@section('content')
    ...
    <div class="row">
        ...
        {{-- <div class="spinner" id="spinner" style="display: none">
            <img src="{{ URL::asset('build/images/preloader.gif') }}" alt="Loading...">
        </div> --}}
        <div class="col-xxl-9">
                ...
                <div class="col-8">
                    <div class="card card-bg-fill">
                        <div class="card-body p-4">
                            <div class="p-2">
                                <form class="preloaderForm" action="{{ route('password') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mt-4 d-flex justify-content-end">
                                        <button class="btn btn-primary" onclick="showSpinner()" type="submit">Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
